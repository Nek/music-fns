...
import type { Chord, Interval, Intervals, ScientificNote, ScientificNotes } from 'src/types';

const createChord = (root: ScientificNote, chord: Intervals): ScientificNotes => {
